...
pub async fn load_msh_file_with_texture() -> (Vec<Pixel>, usize) {
    ...
    let view_state = ViewState { angle_x: 0.0, angle_y: 0.0, angle_z: 0.0, scale: 300.0, c_angle_x: 0.0, c_angle_y: 0.0, c_angle_z: 0.0, camera_x: 0.0, camera_y: 0.0, camera_z: 150.0, ref_x: 0.0, ref_y: 0.0, ref_z: 0.0, perspective_scale: 500.0 };
    load_texture(&mut pixels, count, view_state, width, height, "flower.png", 0, 40).await;

    let view_state = ViewState { angle_x: 0.45, angle_y: 85.0, angle_z: 0.0, scale: 300.0, c_angle_x: 0.0, c_angle_y: 0.0, c_angle_z: 0.0, camera_x: 0.0, camera_y: 0.0, camera_z: 150.0, ref_x: 0.0, ref_y: 0.0, ref_z: 0.0, perspective_scale: 500.0 };
    load_texture(&mut pixels, count, view_state, width, height, "flower.png",0, 40).await;
